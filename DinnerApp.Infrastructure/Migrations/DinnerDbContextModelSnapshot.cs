...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DinnerApp.Domain.MenuAggregate.Menu", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("DinnerApp.Domain.MenuAggregate.Menu", b =>
                {
                    b.OwnsOne("DinnerApp.Domain.Common.ValueObjects.AverageRating", "AverageRating", b1 =>
                        {
                    ...
                    b.OwnsMany("DinnerApp.Domain.DinnerAggregate.ValueObjects.DinnerId", "DinnerIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("DinnerApp.Domain.MenuAggregate.Entities.MenuSection", "Sections", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
                            ...
                            b1.OwnsMany("DinnerApp.Domain.MenuAggregate.Entities.MenuItem", "Items", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .HasColumnType("uniqueidentifier")
                    ...
                    b.OwnsMany("DinnerApp.Domain.MenuReviewAggregate.ValueObjects.MenuReviewId", "MenuReviewIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
